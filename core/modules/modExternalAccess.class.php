...
class modExternalAccess extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->picto='module@externalaccess';
		...
		// for specific css file (eg: /externalaccess/css/externalaccess.css.php)
		...
		//							'css' => array('/externalaccess/css/externalaccess.css.php'),	// Set this to relative path of css file if module has its own css file
		...
		// Example: this->dirs = array("/externalaccess/temp");
		$this->dirs = array();

		// Config pages. Put here list of php page, stored into externalaccess/admin directory, to use to setup module.
		$this->config_page_url = array("externalaccess_setup.php@externalaccess");
        ...
        */
		...
		// $this->menu[$r]=array(	'fk_menu'=>'fk_mainmenu=externalaccess',		// Put 0 if this is a single top menu or keep fk_mainmenu to give an entry on left
		//							'type'=>'top',			                // This is a Top menu entry
		//							'titre'=>'externalaccess top menu',
		//							'mainmenu'=>'externalaccess',
		//							'leftmenu'=>'externalaccess_left',			// This is the name of left menu for the next entries
		...
		// $this->menu[$r]=array(	'fk_menu'=>'fk_mainmenu=externalaccess,fk_leftmenu=externalaccess_left',		    // Use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
		//							'type'=>'left',			                // This is a Left menu entry
		//							'titre'=>'externalaccess left menu',
		//							'mainmenu'=>'externalaccess',
		//							'leftmenu'=>'externalaccess_left',			// Goes into left menu previously created by the mainmenu
		...
		$this->menu[$r]=array(
			'fk_menu'=>'fk_mainmenu=externalaccess',			                // Put 0 if this is a top menu
			'type'=>'left',			                // This is a Top menu entry
			'titre'=>$langs->trans('TopMenuexternalaccess'),
			'mainmenu'=>'externalaccess',
			'leftmenu'=>'externalaccess_left',
			'url'=>'/externalaccess/list.php',
			'langs'=>'externalaccess@externalaccess',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>100+$r,
			'enabled'=>'isModEnabled('externalaccess')',	// Define condition to show or hide menu entry. Use 'isModEnabled('missionorder')' if entry must be visible if module is enabled.
		...
		$this->menu[$r]=array(
			...
			'type'=>'left',			                // This is a Left menu entry
			'titre'=>$langs->trans('LeftMenuexternalaccessCreate'),
			'mainmenu'=>'externalaccess',
			'leftmenu'=>'externalaccess_left_create',
		...
		$this->menu[$r]=array(
			'fk_menu'=>'fk_mainmenu=externalaccess,fk_leftmenu=externalaccess_left',		    // Use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
			'type'=>'left',			                // This is a Left menu entry
			'titre'=>$langs->trans('LeftMenuexternalaccessList'),
			'mainmenu'=>'externalaccess',
			'leftmenu'=>'externalaccess_left_list',
			'url'=>'/externalaccess/list.php',
			'langs'=>'externalaccess@externalaccess',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>100+$r,
			'enabled'=> 'isModEnabled('externalaccess')',  // Define condition to show or hide menu entry. Use 'isModEnabled('missionorder')' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
	...
	public function init($options = '')
	{
		...
		$result=$this->_load_tables('/externalaccess/sql/');
